...
public class TestBehForTPP extends FSMBehaviour {
    ...
    public TestBehForTPP(ProducerData producerData) {
        ...
        registerLastState(new TPP_StorageTicker(getAgent(), 75000, producerData), REFILLINGSTORAGE);
